...
public class WeixinVideoController {
    ...
    public ResultVO list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        Page<VideoDto> videoDtos = videoDetailService.findList(request);
        return ResultVOUtil.success(videoDtos.getContent());
    }
...
//        return new ModelAndView("templates/detail", map);
        return null;
    }
